            ...
            <div class="col-12">
                <div class="menu">
                    <ul class="list">
                        ...
                        <li> <a href="index.php"><i class="icon-speedometer"></i><span>Dashboard</span></a></li>
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="icon-layers"></i><span>UI Elements</span></a>
                            <ul class="ml-menu">
                        ...
                        <li> <a href="javascript:void(0);" class="menu-toggle"><i class="icon-lock"></i><span>Authentication</span></a>
                            <ul class="ml-menu">
                        ...
                        <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="icon-folder-alt"></i><span>Sample Pages</span></a>
                            <ul class="ml-menu">
